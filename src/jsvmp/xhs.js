...
let set_cookie = (cookie) => {
    // transform cookie str to key,value pairs
    let cookie_dict = {}
    ...
    for (let key in cookie_dict) {
        document.cookie = key + '=' + cookie_dict[key]
    }
}

let xs_xt = (url, data, cookie) => {
    set_cookie(cookie)
    return window._webmsxyw(url, data)
}

function get_xs(url, data, cookie) {
    return xs_xt(url, data, cookie)
}

// cookie = 'abRequestId=6a42c3f7-5f4c-572e-9847-bc733cc61073; a1=18f74e3b0e2m6jaraiqcaajn8bmz3765wou17xhp030000156562; webId=6cf889e2d027fb9172e3e69efc3394dc; gid=yYiW4dqDYiEJyYiW4dqD8lCxdJ6KV0F03AS07U80VIYD6yq8uqWK2W888y2K2KJ8K8JJKiYi; xsecappid=xhs-pc-web; webBuild=4.28.5; web_session=0400698f864c4756186c89de81344bc65223be; unread={%22ub%22:%226694c513000000000d00c86c%22%2C%22ue%22:%2266b226fa00000000050330ab%22%2C%22uc%22:10}; websectiga=10f9a40ba454a07755a08f27ef8194c53637eba4551cf9751c009d9afb564467; sec_poison_id=90d12051-885a-4d14-a5ca-32055ba8e60a; acw_tc=76ec22e5109ffafc2e5b34b963be9abf076057eca83590ae6677b9a00cedbf72'
// let url = '/api/sns/web/v2/user/me'
// let data = undefined
// let res = xs_xt(url, data, cookie)
